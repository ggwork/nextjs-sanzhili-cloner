...
export function FloatingBox() {
  ...
  return (
    <div className="fixed right-0 top-[280px] z-40 flex flex-col items-end gap-2">
      ...
      {/* WhatsApp咨询 */}
      <a
        href="https://wa.me/8615155723342"
        target="_blank"
        rel="noopener noreferrer"
        className="group flex px-3 flex-col items-center justify-center overflow-hidden rounded-l-sm bg-[#25D366] py-2 text-white shadow-md transition-all duration-300 w-[84px] hover:w-[120px] hover:bg-[#128C7E]"
        aria-label="WhatsApp"
        title="WhatsApp"
      >

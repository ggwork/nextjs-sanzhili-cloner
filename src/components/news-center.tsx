    ...
    <section className="pt-[60px]">
      <div className="container-content">
        <Reveal variant="fade-up">
          <SectionTitle className="mb-10">新闻中心</SectionTitle>
        </Reveal>
      </div>
      ...
      <div className="mx-auto my-[30px] flex w-[70%] max-[996px]:w-[95%] max-[996px]:flex-wrap">
        {NEWS_COLUMNS.map((col) => (
          <div
            ...
            style={{ marginInline: col === NEWS_COLUMNS[0] ? undefined : "0 0 0 4%" }}
          >
            <ColumnHeader heading={col.heading} moreHref={col.moreHref} />
      ...
      <Reveal variant="fade-right" className="container-content">
        <MoreButton href="/News.aspx?ClassID=6" className="mx-auto mb-[60px] mt-10 flex" >
          了解更多
        </MoreButton>
      </Reveal>
    </section>
